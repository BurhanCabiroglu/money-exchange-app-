...
class selectForeign2 extends StatefulWidget {
  @override
  _select_base_pageState createState() => _select_base_pageState();
}

class _select_base_pageState extends State<selectForeign2> {
      ...
      return Material(
        ...
        child: InkWell(
          onTap: (){
              ...
              setState(() {
                selector.foreign2=public.currencyList[index];
              });
          },
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text("Select Second Currency",style: TextStyle(color: lightGrey,fontSize: size.height/49.77)),
          centerTitle: true,
          leading: FlatButton(
            onPressed: (){
              Navigator.pop(context);
